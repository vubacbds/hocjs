...
(function myFunc() {
  //Có tính Private, nên dc sử dụng để ko bị trùng tên biến tránh lỗi, thường làm cho thư viện dùng chung
  console.log("Now");
})();
...
var bienx = undefined;
var giatri1 = bienx ?? {
  nguoi1: { ten: "bac", age: 22 },
  nguoi2: { ten: "dung", age: 19 },
}; //Nếu bienx là null/undefined trả về object
console.log(giatri1);
...
const student = Object.freeze({
  //Object.freeze là đóng băng không cho sửa
  name: "dung",
  age: 18,
});
...
//git pull : lấy file github về  //Lấy file code từ git của mình về
